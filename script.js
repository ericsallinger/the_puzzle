(function() {
  ...
  const TILE_CONFIG = {
    ...
    "53":  { password: "just", imgSrc: "img/53.jpeg",  message: "" },
    "54":  { password: "friendship", imgSrc: "img/54.jpeg",  message: "" },
    "55":  { password: "and", imgSrc: "img/55.jpeg",  message: "" },
    "56":  { password: "hasta", imgSrc: "img/56.jpeg",  message: "" },
    "57":  { password: "y", imgSrc: "img/57.jpeg",  message: "" },
    "58":  { password: "querer", imgSrc: "img/58.jpeg",  message: "" },
    "59":  { password: "charli)", imgSrc: "img/59.jpeg",  message: "" },
