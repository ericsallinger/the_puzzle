(function() {
  ...
  const TILE_CONFIG = {
    ...
    "30":  { password: "", imgSrc: "img/30.jpeg",  message: "Would Jaz + Eric exist without this excursion??" },
    "31":  { password: "", imgSrc: "img/31.jpeg",  message: "Love is: a pint of ice cream, ori, and not a single plan" },
    "32":  { password: "", imgSrc: "img/32.jpeg",  message: "Jaz-TV is my favorite show" },
    "33":  { password: "", imgSrc: "img/33.jpeg",  message: "I love make things, but when I make things for you it feels so meaningful" },
    "34":  { password: "", imgSrc: "img/34.jpeg",  message: "I propose a tradition! Each Super Bowl Sunday we go out and enjoy being the only ones there" },
    "35":  { password: "", imgSrc: "img/35.jpeg",  message: "Together we: make eachother stronger, pushing to do the things we know we need to do or say" },
    "36":  { password: "", imgSrc: "img/36.jpeg",  message: "" },
    "37":  { password: "", imgSrc: "img/37.jpeg",  message: "" },
    "38":  { password: "", imgSrc: "img/38.jpeg",  message: "" },
    "39":  { password: "", imgSrc: "img/39.jpeg",  message: "" },
    "40":  { password: "", imgSrc: "img/40.jpeg",  message: "" },
    "41":  { password: "", imgSrc: "img/41.jpeg",  message: "'What's that noise up the stairs babe, is it Christmas morning creaks' -Blood Bank (I love this line)" },
    "42":  { password: "", imgSrc: "img/42.jpeg",  message: "" },
  };
