(function() {
  ...
  const TILE_CONFIG = {
    ...
    "163": { password: "my", imgSrc: "img/163.jpeg", message: "The Purple future: The kids come early in this one, turns out your residency program has great benefits so we just decide to send it just before you turn 30" },
    "164": { password: "candles", imgSrc: "img/164.jpeg", message: "For a few years there life felt like it was controlling us not the other way around. Clinic shifts, kids appointments and practices, a visit to the dentist was a luxury " },
    "165": { password: "warmth", imgSrc: "img/165.jpeg", message: "Maybe it's that we started feeling isolated and yearned for community, maybe we were looking for more meaning in the world. We found what we were looking for in religion" },
    "166": { password: "built", imgSrc: "img/166.jpeg", message: "We both had a lot of reservations but we found this new-agey place that talks about unity, and presence, and we find it brings us clarity" },
    "167": { password: "softness", imgSrc: "img/167.jpeg", message: "One day you get home from clinic and find that the sitter in tears. She'd lost track of the youngest kid and they of course found a way to swallow a battery" },
    "168": { password: "eternity", imgSrc: "img/168.jpeg", message: "The aftermath pulls us in different directions, me deeper into the church, you into your own isolation" },
    "169": { password: "clusters", imgSrc: "img/169.jpeg", message: "A wall forms between us, even at mealtime all we can think to talk about together is how the food is" },
    "170": { password: "cutlery", imgSrc: "img/170.jpeg", message: "One day you pick up an old book you hadn't thought about in years. It paints a picture of life as a story that we are merely experiencing" },
    "171": { password: "well", imgSrc: "img/171.jpeg", message: "Though our story has become more pain than pleasure, we are fully conscious of each moment, together, apart, one, whole " },
    "172": { password: "and", imgSrc: "img/172.jpeg", message: "The Gold future: In this one we manage to leave a mark on not just those close to us, but on people who we exist to only as figures" },
    "173": { password: "live", imgSrc: "img/173.jpeg", message: "I think it was a realization of our fortune that led us to the realization first of all. After all, there's not many people out there who got so much values based education" },
    "174": { password: "still", imgSrc: "img/174.jpeg", message: "One day you told me a story of a street outreach clinical organization you had worked with in the past had gone under due to financial concerns, sad but you said it in a way that felt oddly...hopeful?" },
    "175": { password: "steps", imgSrc: "img/175.jpeg", message: "We had never really openly aspired for much from our careers besides fulfilment and helping people, but now in our 40s it felt like the world was more approachable than it had always been" },
    "176": { password: "silences", imgSrc: "img/176.jpeg", message: "Together, we decided we actually had all the resources, skill, and knowledge to start our own street medicine organization. It felt as daunting to us as it sounds now, but we found our way by relying on our network" },
    "177": { password: "aligned", imgSrc: "img/177.jpeg", message: "The organization was successful and we catapaulted into a form of living we had never really asked for, or even registered as a possibility" },
    "178": { password: "that", imgSrc: "img/178.jpeg", message: "Our 50s and 60s professional lives became a whirl of board meetings, fundraising galas, and conferences. You'd always find me front row at one of your panels with the look of admiration that became so familiar" },
    "179": { password: "accept", imgSrc: "img/179.jpeg", message: "We had developed a life that was as much about shaping our community as it was about shaping our family, we aged with grace" },
    "180": { password: "you", imgSrc: "img/180.jpeg", message: "The Blue Future: Happened because the world is a whole lot bigger than it seems with a type A mind" },
    "181": { password: "all", imgSrc: "img/181.jpeg", message: "By our late 30s Our lives had settled into nice, smoothly operating tracks. Wake up after 7.5 hours, see 28 patients, go home, have a nice dinner, watch a show and repeat" },
    "182": { password: "in", imgSrc: "img/182.jpeg", message: "But I couldn't help thinking that a track is basically the same thing as a rut. This promised yellow brick road that we'd been following was turning out to look more like grey" },
    "183": { password: "wrapped", imgSrc: "img/183.jpeg", message: "Then came the happiest day of our lives. You came into the living room holding a little stick. We were having a baby!" },
    "184": { password: "apart", imgSrc: "img/184.jpeg", message: "We never would have predicted it but this ended up being the perfect excuse to uproot and reimagine our lives" },
    "185": { password: "on", imgSrc: "img/185.jpeg", message: "With the war, new labor policies and declining education system, America just didn't have the same allure that originally brought our families here" },
    "186": { password: "shoelace", imgSrc: "img/186.jpeg", message: "What reasons were there for us to stay really? Besides our siblings, we could still visit periodically, your parents had settled in Mexico, my Mom had gone off to Spain " },
    "187": { password: "are", imgSrc: "img/187.jpeg", message: "We looked out into the world for opportunities and found ourselves constructing a new life in Argentina of all places. Our kids did in fact grow up bilingual but reversed of what we expected! No speke kids" },
    "188": { password: "a", imgSrc: "img/188.jpeg", message: "The Green future: Was a 1 in a million but when it happened it felt like it was always our destiny" },
    "189": { password: "and", imgSrc: "img/189.jpeg", message: "That land in Belize that your parents have? Turns out that they managed to turn it into quite the impressive little farm. Your dad's handywork and your mom's negotation skill came together nicely" },
    "190": { password: "everything", imgSrc: "img/190.jpeg", message: "But when your parents got older it became impractical and they came this close to selling it off. That is until we decided to take the biggest leap of our lives" },
    "191": { password: "face", imgSrc: "img/191.jpeg", message: "With no kids rooting us down, it felt like a change of scenery more than a sacrifice. We'd both reached our max fulfillment with medicine and were open to something a little more selfish I suppose?" },
    "192": { password: "was", imgSrc: "img/192.jpeg", message: "The nearly off-grid lifestyle turned out to suit us well, manual labor, waking with the sun, and a bit of simplicity for once was a miracle" },
    "193": { password: "our", imgSrc: "img/193.jpeg", message: "We spent our time just swaying together to the rhythm of life, with a newfound definition of success, based on our happiness above all else" },
    "194": { password: "a", imgSrc: "img/194.jpeg", message: "All these futures I imagine for us hold their own beauty, stress, hope, and apprehension" },
