(function() {
  ...
  const TILE_CONFIG = {
    ...
    "40":  { password: "", imgSrc: "img/40.jpeg",  message: "Hall of fame Jaz+Eric moment number 347" },
    "41":  { password: "", imgSrc: "img/41.jpeg",  message: "Love is: Meaningful moments shared with you, sharing family with you, being happy sad with you" },
    "42":  { password: "", imgSrc: "img/42.jpeg",  message: "'What's that noise up the stairs babe, is it Christmas morning creaks' -Blood Bank (I love this line)" },
    "43":  { password: "", imgSrc: "img/43.jpeg",  message: "Can you believe that our families both live thousands of miles away and yet we've still all met?!" },
    "44":  { password: "", imgSrc: "img/44.jpeg",  message: "That trumpet went so hard" },
    "45":  { password: "", imgSrc: "img/45.jpeg",  message: "Reason number 45 why I love you: We share friends so well" },
    "46":  { password: "", imgSrc: "img/46.jpeg",  message: "This is your perfection in one photo. Beautiful, balanced, silly" },
    "47":  { password: "", imgSrc: "img/47.jpeg",  message: "You turn each shiny surface into a chance for a new memory" },
    "48":  { password: "", imgSrc: "img/48.jpeg",  message: "" },
    "49":  { password: "", imgSrc: "img/49.jpeg",  message: "" },
